<template>
    <div>
        ...
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-3" style="margin-bottom:20px;">{{name}} <span
                    class="badge badge-light">{{version}}</span></h1>
                <p>
                    ...
                    <div class="col-md-6" ref="imgCutterBox" style="height:458px;overflow:hidden;">
                        <div v-if="params.isModal"
                            ...
                            <div style="width:50%;margin:180px auto auto auto;">
                                ...
                                <div class="btn btn-secondary btn-block" @click="forIe9">Crop remote pictures（For
                                    IE9+）
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="imgCutDownBox" :style="'height:458px;'">
                            ...
                            <div class="text-center">
                                <a :class="'btn btn-light'+ (imgSrc?'':' disabled')" :disabled="!imgSrc" :href="imgSrc"
                                   :download="downloadName || 'image.jpg'" role="button">Download</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <form>
                            ...
                            <div class="form-group">
                                <div class="btn btn-primary btn-block" v-if="params.isModal===false"
                                     @click="pluginExe('chooseImg')">{{params.label}}
                                </div>
                                <div class="btn btn-primary btn-block" v-if="params.isModal===true"
                                     @click="pluginExe('handleOpen')">{{params.label}}
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="btn btn-secondary btn-block" @click="forIe9">Crop remote pictures（For
                            ...
                            <div class="form-group">
                                <button type="button" :disabled="params.isModal===true || loadImg===false"
                                        class="btn btn-success btn-block" @click="pluginExe('cropPicture')">Confirm
                                </button>
                            </div>
                            <div class="form-group">
                                <button type="button" class="btn btn-light btn-block" :disabled="params.isModal===true"
                                        @click="pluginExe('clearAll')">Reset
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form autocomplete="off">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group custom-control">
                                        ...
                                        <input @input="setData($event)" :readonly="params.isModal==false"
                                               name="boxWidth" type="text" class="form-control"
                                ...
                                <div class="col">
                                    <div class="form-group custom-control">
                                        ...
                                        <input @input="setData($event)" :readonly="params.isModal==false"
                                               name="boxHeight" type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group custom-control">
                                        ...
                                        <input @input="setData($event)" name="cutHeight" type="text"
                                               class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group custom-control">
                                        ...
                                        <input @input="setData($event)" name="fileType" type="text"
                                               class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group custom-control">
                                        <label for="smallToUpload">smallToUpload（If choose image size less then defined
                                            Size,return file. sizeChange must be false ）：</label>
