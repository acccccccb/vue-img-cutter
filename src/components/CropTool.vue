		  ...
		  <div class="toolMain">
		    ...
		    <div ref="toolBox"
		      ...
		      <div class="tips" v-show="!drawImg.img">
		        <button class="btn btn-primary" @click="chooseImg">请选择要裁剪的图片</button>
		      </div>
		      <div
		        v-show="drawImg.img"
		    ...
		    <div class="toolBar">
		      <div class="toolbar-item">
		        ...
		        <button class="btn btn-primary-plain" @click="chooseImg" type="primary" plain>选择图片</button>
		        <button v-if="!!rate" class="btn btn-primary-plain" disabled type="primary" plain>比例限制:{{rate}}</button>
		      </div>
		    </div>
		  </div>
  ...
  export default {
    ...
    props:{
      ...
      rate:{
		...
		model:['label','boxWidth','boxHeight','rate'],
    data(){
